...
public class _02_GetAllRowColumn extends JDBCParent {
    ...
    public void test2() throws SQLException {
        ...
        // tablolarin basliklarini almak icin
        ...
        while (rs.next()) {
            //kursorun bulundugu satirdaki tum kolonlardaki datalar yazdiriliyor
            for (int i = 1; i <= rsmd.getColumnCount(); i++) {
    ...
    public void test4() throws SQLException {
        ...
        // aynı mysql sonuç ekranında olduğu gibi
        // fakat metod kullanınız, metoda sorguya gönderiniz ve orada yazdırınız.
